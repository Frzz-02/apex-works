...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-2">
            ...
            <div>
                <h1 class="text-3xl font-bold text-slate-800">Edit Menu Item</h1>
                <p class="text-slate-600 mt-1">Update navigation menu item</p>
            </div>
        </div>
    </div>

    <!-- Form -->
    <form action="{{ route('backend.header.update', $header) }}" method="POST">
        @csrf
        @method('PUT')
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   name="menu_label" 
                                   id="menu_label" 
                                   value="{{ old('menu_label', $header->menu_label) }}"
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   name="menu_slug" 
                                   id="menu_slug" 
                                   value="{{ old('menu_slug', $header->menu_slug) }}"
                                   class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                   placeholder="home" 
                                   required>
                            @error('menu_slug')
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" 
                               name="menu_url" 
                               id="menu_url" 
                               value="{{ old('menu_url', $header->menu_url) }}"
                               class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                               placeholder="/">
                        @error('menu_url')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="menu_icon" 
                               id="menu_icon" 
                               value="{{ old('menu_icon', $header->menu_icon) }}"
                               class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <select name="menu_location" 
                                    ...
                                    class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    required>
                                <option value="both" {{ old('menu_location', $header->menu_location) === 'both' ? 'selected' : '' }}>Both (Navbar & Sidebar)</option>
                                <option value="navbar" {{ old('menu_location', $header->menu_location) === 'navbar' ? 'selected' : '' }}>Navbar Only</option>
                                <option value="sidebar" {{ old('menu_location', $header->menu_location) === 'sidebar' ? 'selected' : '' }}>Sidebar Only</option>
                                <option value="footer" {{ old('menu_location', $header->menu_location) === 'footer' ? 'selected' : '' }}>Footer</option>
                            </select>
                            @error('menu_location')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   name="menu_order" 
                                   id="menu_order" 
                                   value="{{ old('menu_order', $header->menu_order) }}"
                                   min="0"
                                   class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            @error('menu_order')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" 
                                       name="show_in_navbar" 
                                       value="1" 
                                       {{ old('show_in_navbar', $header->show_in_navbar) ? 'checked' : '' }}
                        ...
                        <div>
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" 
                                       ...
                                       value="1" 
                                       {{ old('show_in_sidebar', $header->show_in_sidebar) ? 'checked' : '' }}
                                       class="w-5 h-5 text-blue-600 border-slate-300 rounded focus:ring-blue-500">
                        ...
                        <div>
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" 
                                       name="show_in_footer" 
                                       value="1" 
                                       {{ old('show_in_footer', $header->show_in_footer) ? 'checked' : '' }}
                                       class="w-5 h-5 text-blue-600 border-slate-300 rounded focus:ring-blue-500">
                        ...
                        <div>
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" 
                                       name="is_external" 
                                       value="1" 
                                       {{ old('is_external', $header->is_external) ? 'checked' : '' }}
                                       class="w-5 h-5 text-blue-600 border-slate-300 rounded focus:ring-blue-500">
                        ...
                        <div>
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" 
                                       name="open_new_tab" 
                                       value="1" 
                                       {{ old('open_new_tab', $header->open_new_tab) ? 'checked' : '' }}
                                       class="w-5 h-5 text-blue-600 border-slate-300 rounded focus:ring-blue-500">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" 
                                       ...
                                       id="is_button"
                                       value="1" 
                                       {{ old('is_button', $header->is_button) ? 'checked' : '' }}
                                       class="w-5 h-5 text-blue-600 border-slate-300 rounded focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <select name="button_style" 
                                ...
                                <option value="primary" {{ old('button_style', $header->button_style) === 'primary' ? 'selected' : '' }}>Primary</option>
                                <option value="outline" {{ old('button_style', $header->button_style) === 'outline' ? 'selected' : '' }}>Outline</option>
                                <option value="ghost" {{ old('button_style', $header->button_style) === 'ghost' ? 'selected' : '' }}>Ghost</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" 
                                   name="require_auth" 
                                   value="1" 
                                   {{ old('require_auth', $header->require_auth) ? 'checked' : '' }}
                                   class="w-5 h-5 text-blue-600 border-slate-300 rounded focus:ring-blue-500">
