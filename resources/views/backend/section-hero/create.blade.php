...
@section('title', 'Create Hero Panel')
...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-2">
            ...
            <div>
                <h1 class="text-3xl font-bold text-slate-800">Create Hero Panel</h1>
                <p class="text-slate-600 mt-1">Add a new panel to hero slider</p>
            </div>
        </div>
    </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" 
                                  ...
                                  rows="4"
                                  class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                  placeholder="Describe this panel...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('background_overlay_opacity', '0.10') }}"
                               step="0.01"
                               min="0"
                               max="1"
                               class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
