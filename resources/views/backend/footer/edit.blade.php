...
<div class="p-6">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-slate-800">Edit Footer Settings</h1>
        <p class="text-slate-600 mt-1">Update footer content for your website</p>
    </div>

    <form action="{{ route('backend.footer.update', $footer) }}" method="POST" class="bg-white rounded-xl shadow-lg">
        @csrf
        @method('PUT')
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-5 border-l-4 border-blue-600">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <input type="text" name="company_name" value="{{ old('company_name', $footer->company_name) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Company Tagline</label>
                    <input type="text" name="company_tagline" value="{{ old('company_tagline', $footer->company_tagline) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"></div>
                    <div class="md:col-span-2"><label class="block text-sm font-semibold text-gray-700 mb-2">Address</label>
                    <textarea name="company_address" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('company_address', $footer->company_address) }}</textarea></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Phone</label>
                    <input type="text" name="company_phone" value="{{ old('company_phone', $footer->company_phone) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Email</label>
                    <input type="email" name="company_email" value="{{ old('company_email', $footer->company_email) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">WhatsApp</label>
                    <input type="text" name="company_whatsapp" value="{{ old('company_whatsapp', $footer->company_whatsapp) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Website</label>
                    <input type="text" name="company_website" value="{{ old('company_website', $footer->company_website) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"></div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-5 border-l-4 border-green-600">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <input type="text" name="contact_column_title" value="{{ old('contact_column_title', $footer->contact_column_title) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Phone Number</label>
                    <input type="text" name="contact_phone" value="{{ old('contact_phone', $footer->contact_phone) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Link 1 Label</label>
                    <input type="text" name="contact_link_1_label" value="{{ old('contact_link_1_label', $footer->contact_link_1_label) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Link 1 URL</label>
                    <input type="text" name="contact_link_1_url" value="{{ old('contact_link_1_url', $footer->contact_link_1_url) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Link 2 Label</label>
                    <input type="text" name="contact_link_2_label" value="{{ old('contact_link_2_label', $footer->contact_link_2_label) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Link 2 URL</label>
                    <input type="text" name="contact_link_2_url" value="{{ old('contact_link_2_url', $footer->contact_link_2_url) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Link 3 Label</label>
                    <input type="text" name="contact_link_3_label" value="{{ old('contact_link_3_label', $footer->contact_link_3_label) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Link 3 URL</label>
                    <input type="text" name="contact_link_3_url" value="{{ old('contact_link_3_url', $footer->contact_link_3_url) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"></div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg p-5 border-l-4 border-purple-600">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Column Title</label>
                    <input type="text" name="product_column_title" value="{{ old('product_column_title', $footer->product_column_title) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"></div>
                    <div></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Link 1 Label</label>
                    <input type="text" name="product_link_1_label" value="{{ old('product_link_1_label', $footer->product_link_1_label) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Link 1 URL</label>
                    <input type="text" name="product_link_1_url" value="{{ old('product_link_1_url', $footer->product_link_1_url) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Link 2 Label</label>
                    <input type="text" name="product_link_2_label" value="{{ old('product_link_2_label', $footer->product_link_2_label) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Link 2 URL</label>
                    <input type="text" name="product_link_2_url" value="{{ old('product_link_2_url', $footer->product_link_2_url) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Link 3 Label</label>
                    <input type="text" name="product_link_3_label" value="{{ old('product_link_3_label', $footer->product_link_3_label) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Link 3 URL</label>
                    <input type="text" name="product_link_3_url" value="{{ old('product_link_3_url', $footer->product_link_3_url) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500"></div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-r from-red-50 to-red-100 rounded-lg p-5 border-l-4 border-red-600">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <input type="text" name="media_column_title" value="{{ old('media_column_title', $footer->media_column_title) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Media 1 Name</label>
                    <input type="text" name="media_1_name" value="{{ old('media_1_name', $footer->media_1_name) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Media 1 URL</label>
                    <input type="url" name="media_1_url" value="{{ old('media_1_url', $footer->media_1_url) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Media 2 Name</label>
                    <input type="text" name="media_2_name" value="{{ old('media_2_name', $footer->media_2_name) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Media 2 URL</label>
                    <input type="url" name="media_2_url" value="{{ old('media_2_url', $footer->media_2_url) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Media 3 Name</label>
                    <input type="text" name="media_3_name" value="{{ old('media_3_name', $footer->media_3_name) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Media 3 URL</label>
                    <input type="url" name="media_3_url" value="{{ old('media_3_url', $footer->media_3_url) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Media 4 Name</label>
                    <input type="text" name="media_4_name" value="{{ old('media_4_name', $footer->media_4_name) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500"></div>
                    <div><label class="block text-sm font-semibold text-gray-700 mb-2">Media 4 URL</label>
                    <input type="url" name="media_4_url" value="{{ old('media_4_url', $footer->media_4_url) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500"></div>
                </div>
            </div>
        ...
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
            ...
            <button type="submit" class="px-6 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">Update Footer Settings</button>
        </div>
    </form>
</div>
@endsection
