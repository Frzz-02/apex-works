...
<div class="p-8">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Edit Counter</h1>
        <p class="text-gray-600 text-sm mt-1">Update the counter information</p>
    </div>

    <div class="bg-white rounded-lg shadow-sm p-6">
        <form action="{{ route('backend.complete-count.update', $completeCount) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2">
                    ...
                    <input 
                        ...
                        id="title" 
                        name="title" 
                        value="{{ old('title', $completeCount->title) }}"
                ...
                <div class="col-span-2">
                    ...
                    <input 
                        ...
                        id="icon" 
                        name="icon" 
                        value="{{ old('icon', $completeCount->icon) }}"
                    ...
                    @if($completeCount->icon)
                        <div class="mt-3 flex items-center">
                            <p class="text-xs text-gray-600 mr-2">Preview:</p>
                            <i class="{{ $completeCount->icon }} text-2xl text-indigo-600"></i>
                        </div>
                    @endif
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <input 
                        ...
                        id="amount" 
                        name="amount" 
                        value="{{ old('amount', $completeCount->amount) }}"
                ...
                <div class="col-span-2">
                    ...
                    <select 
                        ...
                        required
                    >
                        <option value="active" @selected(old('status', $completeCount->status) == 'active')>Active</option>
                        <option value="inactive" @selected(old('status', $completeCount->status) == 'inactive')>Inactive</option>
                    </select>
                    @error('status')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
