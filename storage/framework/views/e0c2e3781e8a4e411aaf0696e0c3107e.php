...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?php echo e(route('backend.users.create')); ?>" class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl flex items-center space-x-2">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                <?php if($user->id !== 0): ?>
                                    <a href="<?php echo e(route('backend.users.edit', $user->id)); ?>" class="inline-flex items-center px-3 py-1.5 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors">
                                    ...
                                    <?php if($user->id !== auth()->id()): ?>
                                        <form action="<?php echo e(route('backend.users.destroy', $user->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this user?');">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.app.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\apex-works\resources\views/backend/users/index.blade.php ENDPATH**/ ?>