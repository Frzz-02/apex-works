...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <?php if(!$about): ?>
            <a href="<?php echo e(route('backend.section-about.create')); ?>" class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl flex items-center space-x-2">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="space-x-2">
                        <a href="<?php echo e(route('backend.section-about.edit', $about->id)); ?>" class="inline-flex items-center px-4 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                            </svg>
                            Edit
                        </a>
                        <form action="<?php echo e(route('backend.section-about.destroy', $about->id)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this about section?');">
                            <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="text-slate-600"><?php echo e($about->title ?? '-'); ?></p>
                    </div>
                    <div>
                        <h3 class="font-semibold text-slate-700 mb-2">Subtitle</h3>
                        <p class="text-slate-600"><?php echo e($about->subtitle ?? '-'); ?></p>
                    </div>
                    <div class="md:col-span-2">
                        <h3 class="font-semibold text-slate-700 mb-2">Description</h3>
                        <p class="text-slate-600"><?php echo e($about->description ?? '-'); ?></p>
                    </div>
                </div>
            </div>
        </div>
    <?php else: ?>
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="p-12 text-center">
                ...
                <a href="<?php echo e(route('backend.section-about.create')); ?>" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
...
<?php echo $__env->make('backend.app.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\apex-works\resources\views/backend/section-about/index.blade.php ENDPATH**/ ?>