...
<?php $__env->startSection('title', 'Create About Section'); ?>
...
<div class="p-6">
    <div class="mb-6">
        <div class="flex items-center space-x-2 text-sm text-slate-600 mb-2">
            ...
            <span>/</span>
            <a href="<?php echo e(route('backend.section-about.index')); ?>" class="hover:text-slate-900">About Section</a>
            <span>/</span>
    ...
    <form action="<?php echo e(route('backend.section-about.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="title" value="<?php echo e(old('title')); ?>" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-2">Subtitle</label>
                            <input type="text" name="subtitle" value="<?php echo e(old('subtitle')); ?>" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-2">Blockquote</label>
                            <input type="text" name="blockquote" value="<?php echo e(old('blockquote')); ?>" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-2">Description</label>
                            <textarea name="description" rows="4" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"><?php echo e(old('description')); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <div class="space-y-4">
                        <?php $__currentLoopData = range(1, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <label class="block text-sm font-semibold text-slate-700 mb-2">Checklist <?php echo e($i); ?></label>
                                <input type="text" name="checklist_<?php echo e($i); ?>" value="<?php echo e(old('checklist_' . $i)); ?>" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <a href="<?php echo e(route('backend.section-about.index')); ?>" class="block w-full text-center px-6 py-3 mt-3 bg-slate-200 text-slate-700 rounded-lg hover:bg-slate-300 transition-colors">
                        Cancel
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('backend.app.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\apex-works\resources\views/backend/section-about/create.blade.php ENDPATH**/ ?>