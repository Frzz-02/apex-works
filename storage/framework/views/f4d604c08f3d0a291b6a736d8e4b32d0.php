        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center gap-5">
                <div class="text-right hidden sm:block">
                    ...
                    <div class="text-xs opacity-90 capitalize"><?php echo e(Auth::user()->role); ?></div>
                </div>
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    >
                        <div class="px-4 py-3 border-b">
                            <p class="text-sm text-gray-900 font-semibold"><?php echo e(Auth::user()->name); ?></p>
...
<?php /**PATH D:\laragon\www\apex-works\resources\views/backend/app/navbar.blade.php ENDPATH**/ ?>