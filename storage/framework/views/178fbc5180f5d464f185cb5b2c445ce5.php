...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-gradient-to-br from-indigo-500 to-purple-600 text-white p-10 rounded-xl shadow-xl mb-8">
        <h2 class="text-3xl font-bold mb-2">👋 Hello, <?php echo e($user->name); ?>!</h2>
        <p class="text-base opacity-90">You are logged in as <strong class="font-bold"><?php echo e(strtoupper($user->role)); ?></strong>. Manage your content and settings from here.</p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-5 mb-8">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 border-l-4 border-indigo-500">
            ...
            <div class="text-4xl font-bold text-gray-900"><?php echo e($stats['total_users']); ?></div>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 border-l-4 border-emerald-500">
            ...
            <div class="text-4xl font-bold text-gray-900"><?php echo e($stats['total_pages']); ?></div>
        </div>
    </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $loginHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10 bg-indigo-100 rounded-full flex items-center justify-center">
                                            <span class="text-indigo-600 font-semibold text-sm">
                                                <?php echo e(strtoupper(substr($history->user->name, 0, 2))); ?>

                                            </span>
                                        </div>
                                        <div class="ml-3">
                                            <p class="text-sm font-medium text-gray-900"><?php echo e($history->user->name); ?></p>
                                            <p class="text-xs text-gray-500 capitalize"><?php echo e($history->user->role); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900"><?php echo e($history->login_time->format('Y-m-d')); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($history->login_time->format('H:i:s')); ?></div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-500 max-w-xs truncate" title="<?php echo e($history->user_agent); ?>">
                                    <?php echo e(Str::limit($history->user_agent, 50)); ?>
...
<?php echo $__env->make('backend.app.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\apex-works\resources\views/backend/dashboard.blade.php ENDPATH**/ ?>