...
<div class="p-6">
    ...
    <div class="max-w-2xl bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="p-6">
            <form action="<?php echo e(route('backend.users.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    >
                        ...
                        <option value="superadmin" <?php if(old('role') == 'superadmin'): echo 'selected'; endif; ?>>Superadmin</option>
                        <option value="admin" <?php if(old('role') == 'admin'): echo 'selected'; endif; ?>>Admin</option>
                        <option value="moderator" <?php if(old('role') == 'moderator'): echo 'selected'; endif; ?>>Moderator</option>
                    </select>
...
<?php echo $__env->make('backend.app.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\apex-works\resources\views/backend/users/create.blade.php ENDPATH**/ ?>